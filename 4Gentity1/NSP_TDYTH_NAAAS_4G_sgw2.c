...
int NSP_TDYTH_4G_IpNet_Third_SGWSendToPGW(char *pcRecvBuf, char *pcSendBuf)
{
    ...
    memcpy(stIpBodyThirdSGWToPGW.aucGTPSrcIp, D_NSP_TDYTH_NAAAS_SGW2_IP, D_NSP_TDYTH_NAAAS_4G_IP_LEN);
...
int NSP_TDYTH_4G_IpNet_Seventh_SGWToENB(char *pcRecvBuf, char *pcSendBuf)
{
    ...
    memcpy(stIpBodySeventhSGWToENB.aucGTPSrcIp, D_NSP_TDYTH_NAAAS_SGW2_IP, D_NSP_TDYTH_NAAAS_4G_IP_LEN);
...
NSP_TDYTH_4G_TAU_Eighth_NewSGWToPGW(char *pcRecvBuf, char *pcSendBuf, int iSockfd)
{
    ...
    memcpy(stTauBodyEighthNewSGWToPGW.aucSrcId, D_NSP_TDYTH_NAAAS_SGW2_IP, D_NSP_TDYTH_NAAAS_4G_ID_LEN);
    stTauBodyEighthNewSGWToPGW.uiSrcPort = D_NSP_TDYTH_NAAAS_SGW2_PORT;
...
NSP_TDYTH_4G_TAU_Tenth_NewSGWToNewMME(char *pcRecvBuf, char *pcSendBuf, int iSockfd)
{
    ...
    memcpy(stTauBodyTenthNewSGWToNewMME.aucDstId, D_NSP_TDYTH_NAAAS_MME2_IP, D_NSP_TDYTH_NAAAS_4G_ID_LEN);
    stTauBodyTenthNewSGWToNewMME.uiDstPort = D_NSP_TDYTH_NAAAS_MME2_PORT;
    memcpy(stTauBodyTenthNewSGWToNewMME.aucSrcId, D_NSP_TDYTH_NAAAS_SGW2_IP, D_NSP_TDYTH_NAAAS_4G_ID_LEN);
    stTauBodyTenthNewSGWToNewMME.uiSrcPort = D_NSP_TDYTH_NAAAS_SGW2_PORT;
...
NSP_TDYTH_4G_TAU_Sixteenth_OldSGWToOldMME(char *pcRecvBuf, char *pcSendBuf, int iSockfd)
{
    ...
    memcpy(stTauBodySixteenthOldSGWToOldMME.aucSrcId, D_NSP_TDYTH_NAAAS_SGW2_IP, D_NSP_TDYTH_NAAAS_4G_ID_LEN);
    stTauBodySixteenthOldSGWToOldMME.uiSrcPort = D_NSP_TDYTH_NAAAS_SGW2_PORT;
...
int NSP_TDYTH_4G_SGW_ListenAccept_Function()
{
    ...
    SGWSockaddr.sin_port = htons(D_NSP_TDYTH_NAAAS_SGW2_PORT);
    SGWSockaddr.sin_addr.s_addr = inet_addr(D_NSP_TDYTH_NAAAS_SGW2_IP);
