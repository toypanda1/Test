...
int NSP_TDYTH_4G_S1_HandOver_Third_MMESendToTENB(char *pcRecvBuf, char *pcSendBuf)
{
    ...
    if ((iRet = NSP_TDYTH_4G_gen_S1_NH2(aucKasme, aucKenb2, aucNH)) != 0) {
    ...
    memcpy(stS1HOBodyThirdMMEToTENB.aucNH, aucNH, D_NSP_TDYTH_NAAAS_4G_NH_LEN);
    stS1HOBodyThirdMMEToTENB.ucNCC = 0x05;
...
int NSP_TDYTH_4G_S1_HandOver_Fifth_MMESendToSENB(char *pcRecvBuf, char *pcSendBuf)
{
    ...
    stS1HOBodyFifthMMEToSENB.ucNCC = 0x05;
...
NSP_TDYTH_4G_TAU_Third_NewMMEToOldMME(char *pcRecvBuf, char *pcSendBuf, int iSockfd)
{
    ...
    memcpy(stTauBodyThirdNewMMEToOldMME.aucDstId, D_NSP_TDYTH_NAAAS_MME1_IP, D_NSP_TDYTH_NAAAS_4G_ID_LEN);
    stTauBodyThirdNewMMEToOldMME.uiDstPort = D_NSP_TDYTH_NAAAS_MME1_PORT;
    memcpy(stTauBodyThirdNewMMEToOldMME.aucSrcId, D_NSP_TDYTH_NAAAS_MME2_IP, D_NSP_TDYTH_NAAAS_4G_ID_LEN);
    stTauBodyThirdNewMMEToOldMME.uiSrcPort = D_NSP_TDYTH_NAAAS_MME2_PORT;
...
NSP_TDYTH_4G_TAU_Fourth_OldMMEToNewMME(char *pcRecvBuf, char *pcSendBuf, int iSockfd)
{
    ...
    memcpy(stTauBodyForthOldMMEToNewMME.aucSrcId, D_NSP_TDYTH_NAAAS_MME2_IP, D_NSP_TDYTH_NAAAS_4G_ID_LEN);
    stTauBodyForthOldMMEToNewMME.uiSrcPort = D_NSP_TDYTH_NAAAS_MME2_PORT;
...
NSP_TDYTH_4G_TAU_Fifth_NewMMEToOldMME(char *pcRecvBuf, char *pcSendBuf, int iSockfd)
{
    ...
    memcpy(stTauBodyFifthNewMMEToOldMME.aucSrcId, D_NSP_TDYTH_NAAAS_MME2_IP, D_NSP_TDYTH_NAAAS_4G_ID_LEN);
    stTauBodyFifthNewMMEToOldMME.uiSrcPort = D_NSP_TDYTH_NAAAS_MME2_PORT;
...
NSP_TDYTH_4G_TAU_Seventh_NewMMEToNewSGW(char *pcRecvBuf, char *pcSendBuf, int iSockfd)
{
    ...
    memcpy(stTauBodySeventhNewMMEToNewSGW.aucDstId, D_NSP_TDYTH_NAAAS_SGW2_IP, D_NSP_TDYTH_NAAAS_4G_ID_LEN);
    stTauBodySeventhNewMMEToNewSGW.uiDstPort = D_NSP_TDYTH_NAAAS_SGW2_PORT;
    memcpy(stTauBodySeventhNewMMEToNewSGW.aucSrcId, D_NSP_TDYTH_NAAAS_MME2_IP, D_NSP_TDYTH_NAAAS_4G_ID_LEN);
    stTauBodySeventhNewMMEToNewSGW.uiSrcPort = D_NSP_TDYTH_NAAAS_MME2_PORT;
...
NSP_TDYTH_4G_TAU_Eleventh_NewMMEToHSS(char *pcRecvBuf, char *pcSendBuf, int iSockfd)
{
    ...
    memcpy(stTauBodyEleventhNewMMEToHSS.aucSrcId, D_NSP_TDYTH_NAAAS_MME2_IP, D_NSP_TDYTH_NAAAS_4G_ID_LEN);
    stTauBodyEleventhNewMMEToHSS.uiSrcPort = D_NSP_TDYTH_NAAAS_MME2_PORT;
...
NSP_TDYTH_4G_TAU_Thirteenth_OldMMEToHSS(char *pcRecvBuf, char *pcSendBuf, int iSockfd)
{
    ...
    memcpy(stTauBodyThirteenthOldMMEToHSS.aucSrcId, D_NSP_TDYTH_NAAAS_MME2_IP, D_NSP_TDYTH_NAAAS_4G_ID_LEN);
    stTauBodyThirteenthOldMMEToHSS.uiSrcPort = D_NSP_TDYTH_NAAAS_MME2_PORT;
...
NSP_TDYTH_4G_TAU_Fifteenth_OldMMEToOldSGW(char *pcRecvBuf, char *pcSendBuf, int iSockfd)
{
    ...
    memcpy(stTauBodyFifteenthOldMMEToOldSGW.aucDstId, D_NSP_TDYTH_NAAAS_SGW2_IP, D_NSP_TDYTH_NAAAS_4G_ID_LEN);
    stTauBodyFifteenthOldMMEToOldSGW.uiDstPort = D_NSP_TDYTH_NAAAS_SGW2_PORT;
    memcpy(stTauBodyFifteenthOldMMEToOldSGW.aucSrcId, D_NSP_TDYTH_NAAAS_MME2_IP, D_NSP_TDYTH_NAAAS_4G_ID_LEN);
    stTauBodyFifteenthOldMMEToOldSGW.uiSrcPort = D_NSP_TDYTH_NAAAS_MME2_PORT;
...
NSP_TDYTH_4G_TAU_Seventeenth_NewMMEToUE(char *pcRecvBuf, char *pcSendBuf, int iSockfd)
{
    ...
    memcpy(stTauBodySeventeenthNewMMEToUE.aucSrcId, D_NSP_TDYTH_NAAAS_MME2_IP, D_NSP_TDYTH_NAAAS_4G_ID_LEN);
    stTauBodySeventeenthNewMMEToUE.uiSrcPort = D_NSP_TDYTH_NAAAS_MME2_PORT;
    ...
    memcpy(stTauBodySeventeenthNewMMEToUE.aucTAIList[0], D_NSP_TDYTH_NAAAS_4G_ENB2_TAI, D_NSP_TDYTH_NAAAS_4G_TAI_LEN);
...
void * NSP_TDYTH_4G_ListenAccept_MME_Function(int* iSockfd)
{
    ...
    int isin_len = sizeof(MME2Sockaddr);
    ...
    for(;;)
    {
        iRet = recvfrom(*iSockfd, cRecvBuf, D_NSP_TDYTH_NAAAS_4G_MME_BUFF_LEN, 0,
                        (struct sockaddr *) &MME2Sockaddr, &isin_len);
        if (iRet < 0)
        {
            return NULL;
        }
...
int NSP_TDYTH_4G_Epoll_MME_Function()
{
    ...
    if (bind(iFD, (struct sockaddr *) &MME2Sockaddr, sizeof(struct sockaddr)) == -1)
    {
        perror("bind");
        return -1;
    }
